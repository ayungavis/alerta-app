//
//  BestPracticesPhoneContentView.swift
//  AlertaApp
//
...
struct BestPracticesPhoneContentView: View {
    var body: some View {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    Image("phonePlacement3")
                        ...
                        .padding(.leading, 8)
                    Text(
                        "Wearing your phone on a shoulder strap keeps it "
                            + "accessible while allowing the microphone to "
                            + "remain relatively unobstructed. This option "
                            + "offers a good balance between comfort and "
                    ...
                    Image("phonePlacement2")
                        ...
                        .padding(.leading, 8)
                    Text(
                        "Keeping your phone in a pocket is convenient, but "
                            + "clothing and body movement may reduce "
                            + "microphone performance. Alerts will still "
                            + "work, though some sounds may be detected less "
                            + "consistently."
                    )
                    .soraFont(size: 13, weight: .regular)
                    .padding(.horizontal, 24)
